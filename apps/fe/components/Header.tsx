                    ...
                    <div className="md:hidden py-4 border-t border-slate-800">
                        <nav className="flex flex-col space-y-4">
                            ...
                            <div className="pt-4 border-t border-slate-800">
                                <button className="block w-full text-left text-slate-300 hover:text-white transition-colors mb-2">Sign In</button>
                                <button className="block w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors">
                                    Start Free Trial
                                </button>
                            </div>
                        </nav>
